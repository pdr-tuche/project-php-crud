    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h2 class="mb-5">Membros do time e suas Experiências</h2>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="./assets/img/max.jpg" alt="">
                        <h5>Edyllauson</h5>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="./assets/img/marii.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="./assets/img/ph.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="./assets/img/vi.jpg" alt="">
                        <h5>Maria Victória</h5>
                        <p class="text-primary">Desenvolvedora Front-end</p>
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-square btn-outline-secondary rounded-circle mx-1" href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.9s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="./assets/img/ana.jpg" alt="">
                        <h5>Ana Beatriz</h5>
                        <p class="text-primary">Administradora de Banco de Dados</p>
                        <div class ="d-flex justify-content-center">
                            <a class="btn btn-square btn-outline-secondary rounded-circle mx-1" href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
