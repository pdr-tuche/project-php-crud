...
<table style="border-radius:20px">
    <tr style="background-color: black;color:white; height:3rem;">
        ...
        <td style="width: 210px;">Nome do Produto</td>
        <td style="width: 110px;">Alterar</td>
    ...
    <tr style="background-color: grey; padding:3rem">
        <td><?=$dados['id'];?></td>
        <td><?=$dados['titulo'];?></td>
        <td><a href="?pg=alterar&id=<?=$dados['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" id="edit" class="bi bi-pencil-square" viewBox="0 0 16 16">
