...
<body>
    ...
    $busca = "Select * from fale_conosco order by id";
    ...
    <table>
        ...
        <?php while ($dados = mysqli_fetch_array($todos)) { ?>
            ...
            <tr style="background-color: grey;">
                ...
                <td><a href="javascript:confirmaExclusao('excluirfaleconosco.php?&id=<?= $dados['id']; ?>')" class="ask">
